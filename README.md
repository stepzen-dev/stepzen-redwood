...
* [Setup](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#setup)
  * [Fire it up](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#fire-it-up)
* [Project Structure](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#project-structure)
* [StepZen Side](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#stepzen-side)
  * [`products.graphql`](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#productsgraphql)
  * [`index.graphql`](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#indexgraphql)
  * [`config.yaml`](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#configyaml)
  * [Deploy endpoint](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#deploy-endpoint)
  * [Query endpoint](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#query-endpoint)
* [Redwood API Side](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#redwood-api-side)
  * [`products.sdl.js`](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#productssdljs)
  * [`client.js`](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#clientjs)
  * [`products.js`](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#products-service)
* [Redwood Web Side](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#redwood-web-side)
  * [`ProductsCell`](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#productscell)
  * [`HomePage`](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#homepage)
* [Deploy to Netlify](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#deploy-to-netlify)
  * [Setup command](https://github.com/stepzen-samples/stepzen-redwood/blob/main/README.md#setup-command)
...
* `functions` contains a `graphql.js` file auto-generated by Redwood that is required to use the GraphQL API
* `graphql` contains `products.sdl.js` with your GraphQL schema written in a Schema Definition Language
* `lib` contains one file, `client.js`, which uses `graphql-requests` to query your StepZen API
* `services` contains our `products.js` service which includes code for querying or mutating data with GraphQL
